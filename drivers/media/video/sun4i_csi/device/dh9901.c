/*
 * drivers/media/video/sun4i_csi/device/dh9901.c
 *
...
/*
 * A V4L2 driver for Dahua dh9901 chips.
 *
 */
...
MODULE_DESCRIPTION("A low-level driver for Dahua dh9901 sensors");
MODULE_LICENSE("GPL");
...
#define csi_dev_err(x,arg...) printk(KERN_INFO"[CSI_ERR][DH9901]"x,##arg)
#define csi_dev_print(x,arg...) printk(KERN_INFO"[CSI][DH9901]"x,##arg)
...
#define V4L2_IDENT_SENSOR 0x9901
...
/*
 * The dh9901 sits on i2c with ID 0x78
 */
